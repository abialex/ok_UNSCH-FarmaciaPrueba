...
public class Reporte_Por_Escuela extends javax.swing.JPanel {
    ...
    private void jbtnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnImprimirActionPerformed
        String url="Carpeta_de_Archivos\\Reporte_Diagnostico.pdf";
    ...
    public void imprimir(Escuela objEscuela) throws FileNotFoundException, DocumentException, IOException{
        ...
        if(!listaE.isEmpty()){
            ...
            for(Estudiante estudiante : listaE){
                ...
                List<Receta> listaReceta=Herramienta.findbyWhere(Receta.class,"id_Control_paciente", objControl.get(0).getId_Control_paciente(), jpa);
                ...
                for(Receta receta : listaReceta){
                    ...
                    for (Detalle_Medicamentos Detalle_Medicamento : listMedi){   
                        if(Herramienta.BettwenFechas(jcbYearDesde.getDatoFecha(),Detalle_Medicamento.getFecha(), jcbYearHasta.getDatoFecha())){

...
public class Reporte_Por_Escuela_AtendidosBotica extends javax.swing.JPanel {
    ...
    public void imprimirEscuelitas() throws MalformedURLException, IOException{
        ...
        if(!Lista_control_paciente.isEmpty()){
            ...
            if(modelo.getRowCount()==0){
                JOptionPane.showMessageDialog(jPanel7, "No se encontró estudiante en el Rango de la Fecha");
                jbtnImprimir.setEnabled(false);
                }
            document.add(table);  
            document.close();   

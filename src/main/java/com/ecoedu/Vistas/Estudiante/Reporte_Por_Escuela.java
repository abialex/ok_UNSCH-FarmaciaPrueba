...
public class Reporte_Por_Escuela extends javax.swing.JPanel {
    ...
    private void jbtnCrearRecetaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCrearRecetaActionPerformed
        try {
            ...
            Logger.getLogger(Reporte_Por_Escuela.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void imprimir(Escuela objEscuela) throws FileNotFoundException, DocumentException, IOException{
      ...
      for(Estudiante estudiante : listaE){
          ...
          for(Receta receta : listaReceta){
            ...
            table.addCell(new Paragraph("N").setFont(font).setTextAlignment(TextAlignment.CENTER).setFontSize(fontTamaño));//sexo
...
public void llenar_Tabla_de_Recetas(DefaultTableModel modelo){        
            ...
            jtblRecetas.getTableHeader().setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 15));
            ...
            jtblRecetas.getColumnModel().getColumn(5).setPreferredWidth(80); 
            jtblRecetas.getColumnModel().getColumn(6).setPreferredWidth(100); 
            jtblRecetas.getColumnModel().getColumn(7).setPreferredWidth(140);//quedo 
            jtblRecetas.getColumnModel().getColumn(8).setPreferredWidth(50); 
            jtblRecetas.getColumnModel().getColumn(9).setPreferredWidth(45); 
            jtblRecetas.getColumnModel().getColumn(10).setPreferredWidth(45);
            jtblRecetas.getColumnModel().getColumn(11).setPreferredWidth(190); 

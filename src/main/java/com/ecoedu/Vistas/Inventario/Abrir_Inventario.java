...
public class Abrir_Inventario extends javax.swing.JPanel {  
    ...
    private void initComponents() {
        ...
        jlblMensaje1.setText("Si abre ya no podrá llenar lotes");
    ...
    public void imprimirInventarioApertura(Date Fe) throws MalformedURLException, IOException{
        ...
        for (Rol Origen : Lista_Origen){
            ...
            table.addHeaderCell(new Cell().add(new Paragraph("Producto Farmacéutico").setFontSize(tamFond).setFont(bold)).setTextAlignment(TextAlignment.CENTER));         

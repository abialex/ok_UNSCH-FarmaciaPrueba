...
public class CrearSemestredeAtencion extends javax.swing.JPanel{
    ...
    public CrearSemestredeAtencion(EntityManager objJpa,Estudiante objEstudiante,CuadroCarritoMedicinas objCuadroCarritoMedicinas,ServicioFarmacia OBJServicioFarmacia){
        initComponents();
    ...
    public CrearSemestredeAtencion(EntityManager objJpa,Estudiante objEstudiante,CuadroCarritoMedicinas objCuadroCarritoMedicinas,Servicio_Asistencial objServicio_asistencial){
        initComponents();
        auxServis_Farmacia_o_Asistencial=true;
        this.objEstudiante=objEstudiante;
        this.jpa=objJpa;
    ...
    public void principalEjecucion(){
        ...
        jcbNumeroSemestre.setSelectedItem((String)objEstudiante.getSerie());
        desglozarDatos(); 
     }
    ...
    private void initComponents() {
        ...
        jcbNumeroSemestre = new javax.swing.JComboBox<>();
        ...
        jcbNumeroSemestre.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jcbNumeroSemestre.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "100", "200", "300", "400", "500", "600", "700" }));
        jPanel2.add(jcbNumeroSemestre, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 140, 110, 25));
        ...
        jLabel12.setText("Nuevo Semestre de Atención");
    ...
    private void jbtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnAgregarActionPerformed
        ...
        objEstudiante.setSerie((String)jcbNumeroSemestre.getSelectedItem());
    ...
    private javax.swing.JComboBox<String> jcbNumeroSemestre;
